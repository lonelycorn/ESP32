/*
  my_machine_map.h - An embedded CNC Controller with rs274/ngc (g-code) support
  FIXME: placeholder board
...
#define Z_LIMIT_PIN         GPIO_NUM_43
